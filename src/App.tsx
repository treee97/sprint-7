...
function App() {
	...
	const handlerOnChange = (itemPosition: number) => {
		...
		console.log("globalTotal: extraPrice + totalPrice", globalTotal);
...
// LAS CASILLAS DE LAS PAGINAS NO SE REDUCIRAN PORQUE EL ONCHANGE OCURRE FUERA DE LAS CHECKBOX. 
	useEffect(() => {
		const extraPrice = totalWebsite(totalPages, totalLanguages);
		console.log("extraprice", extraPrice);
		...
		console.log(
			"total after setting globaltotal in setTtoal in useEffect",
			total
		);
	}, [totalPages, totalLanguages]);
